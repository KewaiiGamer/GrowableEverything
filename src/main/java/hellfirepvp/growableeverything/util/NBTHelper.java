package hellfirepvp.growableeverything.util;
...
public class NBTHelper {
    ...
    public static NBTTagCompound getPersistentData(NBTTagCompound base) {
        ...
        if (hasPersistentData(base)) {
            compound = base.getCompoundTag(GrowableEverything.MODID);
        } else {
            compound = new NBTTagCompound();
            base.setTag(GrowableEverything.MODID, compound);
        }
        return compound;
    }
    ...
    public static boolean hasPersistentData(NBTTagCompound base) {
        NBTBase modData = base.getTag(GrowableEverything.MODID);
    ...
    public static void removePersistentData(NBTTagCompound base) {
        base.removeTag(GrowableEverything.MODID);
    }
